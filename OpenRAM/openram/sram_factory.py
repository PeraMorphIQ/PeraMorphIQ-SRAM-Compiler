...
class sram_factory:
    ...
    def get_techmodule_type(self, module_type):
        ...
        try:
            ...
            if type(real_module_type) is list:
                ...
                num_ports = globals.OPTS.num_rw_ports + globals.OPTS.num_r_ports + globals.OPTS.num_w_ports
    ...
    def get_usermodule_type(self, module_type):
        ...
        """
        overridden = False
        if hasattr(globals.OPTS, module_type):
            # Retrieve the name from OPTS if it exists,
            # otherwise just use the name
            module_type = getattr(globals.OPTS, module_type)
            overridden = module_type in globals.OPTS.overridden.keys()
