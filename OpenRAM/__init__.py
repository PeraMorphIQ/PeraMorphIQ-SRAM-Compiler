...
# Import everything in globals.py first to make OPTS and other globals available
from .globals import *

# Immediately inject critical items into the openram namespace
# This ensures they're available when submodules import during package initialization
import sys
_openram_module = sys.modules[__name__]
from . import globals as _globals
_openram_module.OPTS = _globals.OPTS
_openram_module.VERSION = _globals.VERSION  
_openram_module.NAME = _globals.NAME
_openram_module.OPENRAM_HOME = _globals.OPENRAM_HOME
_openram_module.find_exe = _globals.find_exe
_openram_module.get_tool = _globals.get_tool
_openram_module.print_time = _globals.print_time
